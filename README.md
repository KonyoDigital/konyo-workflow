...
| **Scar** | Whatever went wrong becomes a rule the next run loads — and at arc end, a territory hit **three** times is **carved into a skill automatically** (evidence archived, never deleted). Ordinary sessions capture too, via hooks; there the carve stays your call |
